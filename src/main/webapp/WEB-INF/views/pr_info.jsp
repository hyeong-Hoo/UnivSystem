                ...
                <div class="container-fluid">
                    ...
                    <div class="search">
						...
						<ul class="box">
							...
							<li class="t2">학과코드 &nbsp; <input type="text" name="code_search" id="code_search" oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g,'$1');" value=${code_search } ></li>
...
$(function(){
	...
	$("#authbtn").click(function(){
		...
		for(var i=0; i<length; i++){
			var prof_no = $("#authlist").children().eq(i).find(".pr_no").text();
			var prof_auth = $("#authlist").children().eq(i).find(".authority").children().val();
			num = num+1;
