...
<script>
function save_btn(){
	var number = $("#pr_no").val();
	var name = $("#pr_name").val();
	var department = $("#pr_dep").val();
	var birth = $("#pr_birth").val();
	var email = $("#pr_email").val();
	var telnumber = $("#pr_telno").val();
	var address = $("#pr_addr").val();
	var addr_detail = $("#pr_detail").val();
...
.info_table{width:100%-20%; height:300px; color:black;}
.info_sub1{ width:20%; height: 40px; text-align: center; line-height: 40px; background-color: #c6cdd4; border: solid 0.5px;}
.info_sub2{ width:20%; height: 40px; text-align: center; line-height: 40px; background-color: #c6cdd4; border: solid 0.5px;}
.info_ans1{ width:30%; height: 40px; text-align: center; line-height: 35px; border: solid 0.5px;}
.info_ans2{ width:30%; height: 40px; text-align: center; line-height: 35px; border: solid 0.5px;}
input{ height: 37px; width:100%;}
.info_list{position: relative; margin-left: -40px;}
.save_btn{background-color: #3E74C7; color: white; border-radius: 3px;}
</style>
</head>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="info_table">
	                    ...
	                    <ul class="info_list">
    	                	<li class="info_sub1">교수번호</li>
        	            	<li class="info_ans1"><input type="text" id="pr_no" name="number"></li>
            	        	<li class="info_sub2">이름</li>
                	    	<li class="info_ans2"><input type="text" id="pr_name" name="name"></li>
                    		<li class="info_sub1">학과명</li>
	                    	<li class="info_ans1"><input type="text" id="pr_dep" name="department"></li>
    	                	<li class="info_sub2">생년월일</li>
        	            	<li class="info_ans2"><input type="text" id="pr_birth" name="birth"></li>
            	        	<li class="info_sub1">이메일</li>
                	    	<li class="info_ans1"><input type="text" id="pr_email" name="email"></li>
                    		<li class="info_sub2">연락처</li>
	                    	<li class="info_ans2"><input type="text" id="pr_telno" name="telnumber"></li>
    	                	<li class="info_sub1">주소</li>
        	            	<li class="info_ans1"><input type="text" id="pr_addr" name="address"></li>
            	        	<li class="info_sub2">상세주소</li>
                	    	<li class="info_ans2"><input type="text" id="pr_detail" name="detail_addr"></li>
                    	</ul>
